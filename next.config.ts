...
const nextConfig: NextConfig = {
  env: {
    ...
    SUPABASE_SERVICE_ROLE_KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im53cGN1cGpzeW56d3F3ZWJzaXJqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3OTc2NTA5OCwiZXhwIjoyMDk1MzQxMDk4fQ.Uh0nkCZXbHTeYsRV92YIQuCYf5Hq8SE1s4JtPKuQqu4',
    ADMIN_EMAIL: 'admin@pridepromart.com',
    ADMIN_PASSWORD: 'Pr1d3Pr0#Adm1n2025!Xy9$',
  },
  images: {
    remotePatterns: [
